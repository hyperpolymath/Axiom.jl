{
  description = "Axiom.jl - {project-description}";
      ...
      in
      {
        ...
        packages.default = pkgs.stdenv.mkDerivation {
          ...
          buildPhase = ''
            ...
            # For Ada: gprbuild -P Axiom.jl.gpr -XMODE=release
          '';

          installPhase = ''
            mkdir -p $out/bin
            # *REMINDER: Add install commands*
            # cp target/release/Axiom.jl $out/bin/  # Rust
            # cp bin/Axiom.jl $out/bin/  # Ada
          '';
        ...
        apps.default = {
          type = "app";
          program = "${self.packages.${system}.default}/bin/Axiom.jl";
        };
        ...
        checks = {
          ...
          test = pkgs.runCommand "test-Axiom.jl" {
