...
- [ ] Non-GPU accelerators (TPU/NPU/PPU/MATH/CRYPTO/FPGA/DSP) backend strategy (in progress: targets, detection, compiled dispatch, fallback/strategy CI, capability/evidence reporting, runtime self-healing diagnostics, resilience CI/evidence, and strict-mode gating shipped for TPU/NPU/PPU/MATH/CRYPTO/DSP via `coprocessor_capability_report`, `coprocessor_runtime_diagnostics`, `scripts/coprocessor-evidence.jl`, `test/ci/coprocessor_resilience.jl`, `scripts/coprocessor-resilience-evidence.jl`, `test/ci/tpu_required_mode.jl`, `scripts/tpu-strict-evidence.jl`, `test/ci/npu_required_mode.jl`, `scripts/npu-strict-evidence.jl`, `test/ci/ppu_required_mode.jl`, `scripts/ppu-strict-evidence.jl`, `test/ci/math_required_mode.jl`, `scripts/math-strict-evidence.jl`, `test/ci/crypto_required_mode.jl`, `scripts/crypto-strict-evidence.jl`, `test/ci/dsp_required_mode.jl`, and `scripts/dsp-strict-evidence.jl`; production kernels remain).
