...
image:[Mozilla Public License 2.0-MPL-1.0,link="https://github.com/hyperpolymath/palimpsest-license"] image:[Mozilla Public License 2.0,link="https://github.com/hyperpolymath/palimpsest-license"]
:toc:
:sectnums:
...
|`LICENSE.txt`
|MPL-2.0 (Julia ecosystem requirement)
